...
## 📖 Installation
This can be installed via Pip, Pipenv, or Docker. To start, clone the repo to your local computer and change into the proper directory.

```
$ git clone https://github.com/akshaykhoje/Data-Science-Project
$ cd 'Data Science Project'/frontend
```
